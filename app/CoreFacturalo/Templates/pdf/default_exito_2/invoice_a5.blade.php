...
<table class="full-width">
    <tr>
        ...
        @endif
        <td width="45%" class="pr-5" class="text-center">
            <div class="text-left">
...
<table class="full-width mt-1 mb-0">
    ...
    <tr class="">
        ...
        <th class="border-box text-center py-2" width="8%" style="background-color:lightgray; font-size:11px">UNIDAD</th>
        <th class="border-box text-left py-2" style="background-color:lightgray; font-size:11px">DESCRIPCIÓN</th>
        ...
        <tr class= "">
            <td class="text-center align-top" style="border-left:1px solid black; border-right:1px solid black">
                ...
                <td class="text-center align-top">
                    @php
                        $unitType = \App\Models\Tenant\Catalogs\UnitType::find($row->item->unit_type_id);
                    @endphp
                    {{ $unitType ? $unitType->description : '' }}
                </td>
                <td class="text-left align-top" style="border-left:1px solid black; border-right:1px solid black">
