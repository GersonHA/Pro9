    ...
    class ItemResource extends JsonResource
    {
        ...
        public function toArray($request)
        {
            ...
            return [
                ...
                'image_url' => ($this->image !== 'imagen-no-disponible.jpg' && $this->image !== 'imagen-no-disponible.webp') ? asset('storage' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'items' . DIRECTORY_SEPARATOR . $this->image) : asset("/logo/{$this->image}"),
